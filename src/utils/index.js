...
import { clientV2 as client, blockClient } from '../apollo/client'
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://swap.spiritswap.finance/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://swap.spiritswap.finance/#/swap?inputCurrency=${
      token0Address === '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83' ? 'FTM' : token0Address
